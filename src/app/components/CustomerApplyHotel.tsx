...
const CustomerApplyHotel: React.FC<Props> = ({ show, visaList, onApiDataReceived, manualValue, visaListLoader }) => {
  ...
  const onSubmit = (values: any) => {
    ...
    axiosInstance
      .get('/backend/fetch_normal_user_dummy_hotel')
      .then((response) => {
...
export default CustomerApplyHotel
