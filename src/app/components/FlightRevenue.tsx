...
const FlightRevenue: React.FC<Props> = ({ className, title, data, loading }) => {
  ...
  const currentItemsFlight = data.slice(startIndex, endIndex);
  ...
  function handleDownloadCSVRevenue() {
    const revenueCSVData = convertToCSV(currentItemsFlight);
