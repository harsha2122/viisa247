...
const CustomerApplyFlight: React.FC<Props> = ({ show, visaList, onApiDataReceived, manualValue, visaListLoader }) => {
  ...
  console.log("sd", postData)
    ...
    axiosInstance
      .get('/backend/fetch_normal_user_dummy_flight')
      .then((response) => {
        if (!response.data.data || response.data.data.length === 0) {
          toast.error('Oops !!\nHotel for this country is not available.', {
            style: {
              background: '#fff',
              color: '#ff4444',
            },
        ...
        <Formik validationSchema={null} initialValues={initValues} onSubmit={onSubmit}>
          {({handleSubmit}) => (
            ...
            <Form className='w-100' noValidate id='kt_create_account_form' onSubmit={handleSubmit}>
              ...
              >
                <h1 style={{fontSize:"30px"}} className='mb-20'>Get dummmy flight tickets</h1>
                {/* From Country */}
...
export default CustomerApplyFlight
