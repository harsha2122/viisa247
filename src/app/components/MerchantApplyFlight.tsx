...
const MerchantApplyFlight: React.FC<Props> = ({ show, visaList, onApiDataReceived, manualValue, visaListLoader }) => {
  ...
  const onSubmit = (values: any) => {
    ...
    axiosInstance
      .get('/backend/fetch_dummy_flight_data')
      .then((response) => {
...
export default MerchantApplyFlight
