...
const DummyFlight: React.FC<Props> = ({ className, title, data, loading }) => {
...
const [deleteId, setDeleteId] = useState<string | null>(null);
  const [formData, setFormData] = useState({
    ...
    description: '',
    flight_price_b2c: '',
    flight_price_partner: '',
    flight_price_retailer: '',
    flight_actual_price: '',
  });
  ...
  const handleDelete = async () => {
    try {
      const response = await axiosInstance.post('/backend/delete_dummy_flight', { _id: deleteId });
      ...
      <div className="card-body">
        <div className="age-group-tabs">
          ...
          <div className='w-75 d-flex justify-content-end gap-3'>
            <Button variant="primary" onClick={handleShow}>+ Add Flight</Button>
            <input
              type="text"
                ...
                >
                  ...
                  <div className="pricing-details">
                    ...
                    <div className="pricing-features">
                      <div className="feature">B2C Price: <span>₹{flight.flight_price_b2c}</span></div>
                      <div className="feature">Partner Price: <span>₹{flight.flight_price_partner}</span></div>
                      <div className="feature">Retailer Price: <span>₹{flight.flight_price_retailer}</span></div>
                      <div className="feature">Actual Price: <span>₹{flight.flight_actual_price}</span></div>
                    </div>
                    <hr className='aahr' />
                    ...
                    <button
                        ...
                        onClick={() => handleDeleteShow(flight._id)}
            ...
            <Row>
              <Col md={6}>
                <Form.Group controlId="formB2CPrice" className="mb-3">
                  ...
                  <Form.Control
                    type="number"
                    name="flight_price_b2c"
                    value={formData.flight_price_b2c}
                    onChange={handleChange}
                  />
                </Form.Group>
              </Col>
              <Col md={6}>
                <Form.Group controlId="formPartnerPrice" className="mb-3">
                  ...
                  <Form.Control
                    type="number"
                    name="flight_price_partner"
                    value={formData.flight_price_partner}
                    onChange={handleChange}
                  />
                </Form.Group>
              </Col>
            ...
            <Row>
              <Col md={6}>
                <Form.Group controlId="formRetailerPrice" className="mb-3">
                  ...
                  <Form.Control
                    type="number"
                    name="flight_price_retailer"
                    value={formData.flight_price_retailer}
                    onChange={handleChange}
                  />
                </Form.Group>
              </Col>
              <Col md={6}>
                <Form.Group controlId="formActualPrice" className="mb-3">
                  ...
                  <Form.Control
                    type="number"
                    name="flight_actual_price"
                    value={formData.flight_actual_price}
                    onChange={handleChange}
                  />
                </Form.Group>
              </Col>
