...
function FlightFormView({ viewApplication }) {
  const inputStyle = {
      ...
      <div className='d-flex' style={{ width: '100%' }}>
        <div style={{ width: '40%', marginTop: 70 }}>
          ...
          <div style={{
            ...
            <img
              src={viewApplication.passport_front || 'placeholder.jpg'} // Placeholder image
              alt='Uploaded Image'
              style={{ maxWidth: '100%', maxHeight: '100%' }}
            />
          </div>
          <button
            onClick={() => handleDownload(viewApplication.passport_front)}
            style={{
              position: 'relative',
              color: '#fff',
              border: 'none',
              ...
              <Form className='py-20 px-9' noValidate id='kt_create_account_form'>
                <div>
                  ...
                  <div className='d-flex' style={{ justifyContent: 'space-between' }}>
                    <div className='fv-row mb-5'>
                      <label className='d-flex align-items-center form-label'>
                        <span className='required'>Merchant Flight Amount</span>
                      </label>
                      <Field
                        style={inputStyle}
                        readOnly
                        value={viewApplication.merchant_flight_amount}
                        name='birthPlace'
                        className='form-control form-control-lg form-control-solid'
                      />
                      <div className='text-danger mt-2'>
                    ...
                    <div className='fv-row mb-5'>
                      ...
                      <Field
                        style={inputStyle}
                        readOnly
                        value={viewApplication.flight_original_amount}
                        name='birthPlace'
                        className='form-control form-control-lg form-control-solid'
                      />
                      <div className='text-danger mt-2'>
                  ...
                  <div className='d-flex' style={{ justifyContent: 'space-between' }}>
                    <div className='fv-row mb-5'>
                      <label className='d-flex align-items-center form-label'>
                        <span className='required'>Flight Status</span>
                      </label>
                      <Field
                        style={inputStyle}
                        readOnly
                        value={viewApplication.flight_status}
                        name='flightStatus'
                        className='form-control form-control-lg form-control-solid'
                      />
                    </div>
