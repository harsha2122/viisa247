...
import CustomerApplyFlight from '../../../components/CustomerApplyFlight';
import { FlightTable1 } from '../../../components/FlightTable1';

function CustomerNewFlight() {
...
export default CustomerNewFlight;
