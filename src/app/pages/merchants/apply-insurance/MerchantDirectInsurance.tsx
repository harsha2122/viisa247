...
import { InsuranceTabled } from '../../../components/InsuranceTabled';
import { Verticalii } from '../../../modules/wizards/components/Verticalii';
import MerchantDirectApply from '../../../components/MerchantDirectApply';
import { DirectVerticalii } from '../../../modules/wizards/components/DirectVerticalii';
...
interface InsuranceData {
  // Define the structure of insuranceData here
  id: string;
  amount: number;
  // other properties
}

function MerchantDirectInsurance() {
...
export default MerchantDirectInsurance;
