    ...
    <>
        ...
        <div className='tac-conti1' >
            <div className="box">
                ...
                <div className="box2">
                    <h1 style={{fontSize:"2.5vw"}}>Welcome to Visa 247. Before using our services, we kindly ask you to review our privacy policy outlined below:</h1>
                </div>
            </div>
            
        </div>

        <div className="tac-conti12">
...
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Visa 247.</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to Visa 247, accessible from <a href="https://visa247.co.in/" rel="external nofollow noopener" target="_blank">https://visa247.co.in/</a></p>
</li>
<li>
...
<ul>
<li>By email: support@visa247.co.in</li>
</ul>
