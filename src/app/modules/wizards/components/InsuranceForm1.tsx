                ...
                <div>
                  ...
                  <hr className='my-12'
                    style={{
                      ...
                      border: 0,
                      height: '1px',
                      backgroundImage:'linear-gradient(to right, rgba(0, 0, 0, 0.50), rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.50))',
                    }}
                  />
                  <h4 className='my-10'>Nominee Details</h4>
                  <div className='d-flex gap-8'>
                    <div className='fv-row gap-8 w-100 mb-5'>
                      <label className='form-label required'>First Name</label>
                      ...
                      <Field
                        ...
                        style={inputStyle}
                        className='form-control form-control-lg form-control-solid'
                        onChange={(e) => handleFieldChange('nomineefirstName', e.target.value)}
                      />
                      <div className='text-danger mt-2'>
                        <ErrorMessage name='businessName' />
                      </div>
                    ...
                    <div className='fv-row gap-8 w-100 mb-5'>
                      ...
                      <Field
                        ...
                        className='form-control form-control-lg form-control-solid'
                        onChange={(e) => handleFieldChange('nomineelastName', e.target.value)}
                      />
                      <div className='text-danger mt-2'>
                        <ErrorMessage name='businessDescriptor' />
                      </div>
                  ...
                  <div className='fv-row gap-8 w-100 mb-5'>
                    <label className='d-flex align-items-center form-label'>
                      <span className='required'>Relation</span>
                    </label>
                    <Field
                        as='select'
                        style={{...inputStyle, width: '100%', backgroundColor: 'white'}}
                        ...
                        className='form-select form-select-lg form-select-solid'
                        onChange={(e) => handleFieldChange('nomineerelation', e.target.value)}
                      >
                        <option></option>
                        <option></option>
                        <option value='Spouse'>Spouse</option>
                    ...
                    <div className='text-danger mt-2'>
                      <ErrorMessage name='nomineerelation' />
                    </div>
                  </div>
                </div>
              </Form>
