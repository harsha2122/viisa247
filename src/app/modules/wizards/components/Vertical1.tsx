...
const Vertical1 = ({ visaListLoader, show, visaList, selectedEntry, showfinalSubmitLoader }: VerticalProps) => {
            ...
            >
              ...
              >
                ...
                <hr style={{
                  ...
                  height: "1px",
                  margin:"10px 0px",
                  backgroundImage: "linear-gradient(to right, rgba(0, 0, 0, 0.50), rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0.50))"
                }} />
                <div className='d-flex' style={{ justifyContent: 'space-between', width: '100%' }}>
